 ...
 * </p>
 * <p>
 * You can define match functions with annotation {@link org.binwang.bard.core.marker.Match} on it.
 * These functions must return a boolean value.
 * </p>
 * <p>
 * You can also define cleanup functions with annotation {@link org.binwang.bard.core.marker.After}.
 * </p>
 *
 * @param <AnnotationType> Which annotation is this adapter bind to. It should be the same class you define in @BindTo .
 * @see org.binwang.bard.core.BindTo
 */
public abstract class Adapter<AnnotationType extends Annotation>
    extends GenericHandler<AnnotationType> {

    /**
     * Run all the methods with annotation {@link org.binwang.bard.core.marker.Match}, see if all the methods return true.
     *
     * @return True if all the methods with {@link org.binwang.bard.core.marker.Match} return true. Otherwise return false.
